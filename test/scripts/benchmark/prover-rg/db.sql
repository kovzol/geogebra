...
insert into provers (name, engine, method, platform) values ('Classic5_m', 'GG', 'default', 'desktop');
insert into provers (name, engine, method, platform) values ('Classic5_t', 'GG', 'default', 'desktop');
