...
public class Compute {
	...
	private static String epcDef() {
		...
		return "; epcx - version 2.0 2023-03-28 - Chris Brown\n"
				...
				+ "                   (qepcad-api-call (qepcad-api-call G 'E) 'T) ; inner call does QE, outer call simplifies result (e.g. if there are assumptions)\n"
				+ "                   (if (equal? (t-type G) 5) ; is G a disjunction of formulas?\n"
				+ "                       (qepcad-api-call (bin-reduce t-or (map (lambda (H) (qepcad-api-call (t-ex V H) 'T)) (getargs G))) 'T)\n"
